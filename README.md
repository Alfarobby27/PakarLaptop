...
Aplikasi web **Sistem Pakar** untuk membantu mendiagnosa kerusakan laptop berdasarkan gejala yang dipilih pengguna.  
Menggunakan metode **Forward Chaining** sebagai mesin inferensi untuk menghasilkan diagnosa dan solusi perbaikan secara sistematis dan terstruktur.
...
Basis pengetahuan sistem disusun berdasarkan referensi dari video teknisi laptop profesional berikut:
...
Informasi dari video tersebut dianalisis dan direpresentasikan ke dalam bentuk aturan (rules) untuk mendukung proses inferensi menggunakan metode **Forward Chaining**.
